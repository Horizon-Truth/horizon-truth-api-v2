import { IsString, IsNotEmpty, IsEnum, IsOptional, IsUrl, IsUUID, IsArray } from 'class-validator';
...
export class CreateReportDto {
    ...
    @ApiPropertyOptional({ enum: ReportPriorityLevel, default: ReportPriorityLevel.MEDIUM })
