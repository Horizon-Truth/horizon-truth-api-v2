    ...
    const blogsData = [
      {
        ...
        excerpt:
          "As deepfakes and AI-generated content become more sophisticated, distinguishing truth from fiction is getting harder. Here's our guide to navigating this new reality.",
        content: `
      ...
      },
      {
        ...
        excerpt:
          "Misinformation isn't just a technical problem; it's a social one. Discover how local communities are coming together to verify information.",
    ...
    const resourcesData = [
      {
        ...
        description:
          'Learn essential steps to verify social media posts and identify fake news effectively.',
        duration: '15 min read',
        badge: 'Most Popular',
        icon: 'FileText',
        fullContent:
          'This handbook provides a step-by-step framework for verifying digital content. It covers reverse image search, source checking, and lateral reading techniques.',
      },
      {
        ...
        type: ResourceType.GUIDE,
        description:
          'How gamified learning and crowdsource reporting combine to protect digital integrity.',
      ...
      },
      {
        ...
        description:
          'A visual guide to the viral nature of misinformation across digital platforms.',
        duration: '6 min',
        icon: 'Video',
      },
      {
        ...
        description:
          'A comprehensive course on why digital honesty matters in the modern era.',
        duration: '45 min',
        icon: 'BookOpen',
      },
    ];
