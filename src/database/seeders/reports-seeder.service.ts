...
export class ReportsSeederService {
    ...
    private async seedReportTags() {
        ...
        const tags = [
            { name: 'Disinformation', slug: 'disinformation', description: 'Intentional spread of false information' },
            { name: 'Hate Speech', slug: 'hate-speech', description: 'Content that attacks people based on attributes' },
            { name: 'Deepfake', slug: 'deepfake', description: 'AI-generated manipulated media' },
            { name: 'Propaganda', slug: 'propaganda', description: 'Biased or misleading information used to promote a cause' },
            { name: 'Incitement', slug: 'incitement', description: 'Content encouraging illegal acts or violence' },
            { name: 'Scam', slug: 'scam', description: 'Deceptive content intended to defraud' },
        ];
