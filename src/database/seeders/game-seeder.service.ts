...
export class GameSeederService {
  ...
  private async seedScenarios() {
    ...
    await this.createScenario({
      ...
      description:
        'A shocking claim goes viral on social media. Can you distinguish fact from fiction?',
      ...
      scenes: [
        {
          ...
          title: 'The Discovery',
          description:
            'You come across a viral post claiming a major health breakthrough',
          ...
          content: {
            textBody:
              'BREAKING: Scientists discover miracle cure that eliminates all diseases! Shared 50,000 times in the last hour.',
          },
        },
        {
          order: 2,
          ...
          content: {
            textBody:
              "The original post links to a website you've never heard of. No major news outlets are reporting this story.",
          },
        },
        {
          order: 3,
          ...
          content: {
            textBody:
              'You find that the website is known for spreading misinformation. The "scientists" mentioned don\'t exist.',
          },
        },
      ],
    });
      ...
      scenes: [
        {
          ...
          content: {
            textBody:
              'SHOCKING: Government Plans to Ban All Social Media Next Week!',
          },
        },
        {
          order: 2,
          ...
          content: {
            textBody:
              'The article cites "anonymous sources" and uses dramatic language. Other news sites aren\'t reporting this.',
          },
        },
      ],
    });
