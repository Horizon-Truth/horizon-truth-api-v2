...
export class GameSeederService {
  ...
  private async seedRegions() {
    ...
    const regions = [
      {
        name: 'Silicon Delta',
        description: 'A bustling hub of technology and innovation.',
      },
      {
        name: 'Neo-Tokyo',
        description: 'A neon-lit metropolis where data is currency.',
      },
      {
        name: 'Cyber-London',
        description:
          'A blend of historic landmarks and high-tech infrastructure.',
      },
      {
        name: 'Silicon-Forest',
        description: 'A peaceful region known for its sustainable tech.',
      },
      {
        name: 'Digital Oasis',
        description:
          'A remote location dedicated to secure information storage.',
      },
    ];
  ...
  private async seedScenarios() {
      ...
      scenes: [
        {
          ...
          content: {
            textBody:
              'Welcome, Agent. I am your Truth Verification Assistant. Ready to begin?',
          },
          choices: [
            {
              label: 'HELLO',
              actionType: PlayerActionType.CHOICE,
              nextSceneTitle: 'The Choice',
            },
            {
              label: 'WHO_ARE_YOU',
              actionType: PlayerActionType.CHOICE,
        ...
        },
        {
          ...
          content: {
            textBody:
              'Every action you take affects your Trust Score. High score means you are a reliable agent.',
          },
          choices: [
            {
              label: 'LETS_GO',
              ...
              outcome: {
                ...
                endScenario: true,
                message:
                  'Tutorial complete! You are ready for your first real challenge.',
              },
            },
          ],
        },
    ...
    await this.createScenario({
      ...
      description:
        'Someone is offering an "exclusive" crypto tip in a Telegram group.',
      levelNumber: 1,
      scenarioType: ScenarioType.CHAT_CONVERSATION,
      difficulty: ScenarioDifficulty.EASY,
      scenes: [
        {
          ...
          content: {
            textBody:
              'Hey! I saw you in the group. Want a 500% return on BTC in 2 hours? Just click: bit.ly/easy-btc-profit',
          },
          choices: [
            {
              label: 'CLICK_LINK',
              ...
              outcome: {
                ...
                endScenario: true,
                message:
                  'Your share increased Panic Score of {{reach}} people by {{percent}}%! You fell for a phishing link. Your account has been compromised.',
              },
            },
            {
              label: 'CHECK_PROFILE',
              actionType: PlayerActionType.CHOICE,
              nextSceneTitle: 'Fake Credentials',
            },
            {
              label: 'BLOCK',
              actionType: PlayerActionType.CHOICE,
              outcome: {
                ...
                endScenario: true,
                message:
                  'Excellent. You avoided a common crypto scam by recognizing high-pressure tactics.',
              },
            },
          ],
        },
        {
          ...
          content: {
            textBody:
              'The profile was created 10 minutes ago and has no mutual contacts. The profile picture is a generic stock photo.',
          },
          choices: [
            {
              label: 'REPORT',
              ...
              outcome: {
                ...
                endScenario: true,
                message:
                  'Great job! Reporting these accounts helps keep the community safe.',
              },
            },
          ],
        },
      ...
      scenes: [
        {
          ...
          content: {
            textBody:
              'URGENT: Abnormal activity on your account. Login to verify: x-bank-verify.com/login or your account will be suspended in 30 mins.',
          },
          choices: [
            {
              label: 'LOGIN_NOW',
              ...
              outcome: {
                ...
                endScenario: true,
                message:
                  'You entered your credentials on a fake site. Your savings are now vulnerable.',
              },
            },
            {
              ...
              outcome: {
                ...
                endScenario: true,
                message:
                  'The bank confirms it was a scam. Always use official apps or numbers to verify alerts.',
              },
            },
          ],
        },
    ...
    await this.createScenario({
      ...
      description:
        'A whistleblower claims to have proof of local government corruption.',
      levelNumber: 2,
      ...
      scenes: [
        {
          ...
          content: {
            textBody:
              'The Mayor is taking bribes for the new harbor project. Here is a photo of the transaction.',
          },
          choices: [
            {
              label: 'ANALYZE_METADATA',
              actionType: PlayerActionType.CHOICE,
              nextSceneTitle: 'Digital Fingerprints',
            },
            {
              label: 'MEET_WHISTLEBLOWER',
              actionType: PlayerActionType.CHOICE,
              nextSceneTitle: 'The Dark Alley',
            },
            {
              ...
              outcome: {
                ...
                endScenario: true,
                message:
                  'The photo was a deepfake created by a political rival. You have committed libel and ruined your reputation.',
              },
            },
          ],
        },
        {
          ...
          content: {
            textBody:
              "Metadata shows the photo was edited 2 hours ago. Shadow angles don't match the clock in the background.",
          },
          choices: [
            {
              label: 'FLAG_FAKE',
              ...
              outcome: {
                ...
                endScenario: true,
                message:
                  'Brilliant detection. You identified the "Midnight Witness" as a professional disinformation operation.',
              },
            },
          ],
        },
        {
          ...
          content: {
            textBody:
              'A man in a hood offers you 50,000 to "leak" this specific version of the story. It includes extra accusations.',
          },
          choices: [
            {
              ...
              outcome: {
                ...
                endScenario: true,
                message:
                  'You sold your integrity. You are no longer fit to be a truth agent.',
              },
            },
            {
              ...
              outcome: {
                ...
                endScenario: true,
                message:
                  'Heroic integrity. You exposed both the fake news and the attempt to bribe the press.',
              },
            },
          ],
        },
