...
import { MassiveScenarioSeederService } from './database/seeders/massive-scenario-seeder.service';
...
async function bootstrap() {
  ...
  const massiveScenarioSeeder = app.get(MassiveScenarioSeederService);
  ...
  try {
    ...
    console.log('--- Starting Massive 1000 Scenario Seeding ---');
    await massiveScenarioSeeder.seed();
